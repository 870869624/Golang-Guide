...
通过 [https://2024.ch3nyang.top/ in new window](https://2024.ch3nyang.top/) 这个网站你可以一键生成一个在线的 Github 简历。

开源项目链接：[https://github.com/WCY-dt/my-github-2024?tab=readme-ov-file in new window](https://github.com/WCY-dt/my-github-2024?tab=readme-ov-file)

当时我参加的校招的时候，个人信息那里就放了一个在线的 Github 简历。我觉得这样会让面试官感觉你是一个内行，会提高一些印象分。

但是，如果你的 Github 没有什么项目的话还是不要放在简历里面了。生成后的效果如下图所示。

[Github简历]![1742184818024](image/Github小技巧/1742184818024.png)
...
![img](https://oss.javaguide.cn/2020-11/image-20201107145749659.png)

使用 SourceGraph 阅读代码的就像下面这样，同样是树形结构展示代码，但是我个人感觉没有 Octotree 的手感舒服。不过，SourceGraph 内置了很多插件，而且还支持类之间的跳转！

![img](https://oss.javaguide.cn/2020-11/image-20201107150307314.png)
...
![img](https://oss.javaguide.cn/2020-11/image-20201107160817672.png)
...
![img](https://oss.javaguide.cn/2020-11/iShot2020-11-07%2016.14.14%20(1).png)
...
![img](https://oss.javaguide.cn/github/javaguide/github-explore.png)
...
![img](https://oss.javaguide.cn/github/javaguide/image-20211227100147433.png)
