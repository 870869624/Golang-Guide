...
```bash
#查看日志是否持久化，false就是未持久化
[root@master ~]# helm get values --all -n topsec-topaiop topsec-topaiop | grep loggerPersistent
loggerPersistent: false
...
```bash
[root@master ~]# kubectl logs -f -n topsec-topngdlp -l app=agent-nginx | grep '672C2B42863EE193E04CB37D2AD9A9E3005056AB868F'
